...
@parameterized_class([
    {
        "org_payload": TEST_PAYLOAD[0][0]["org_payload"],
        "repos_payload": TEST_PAYLOAD[0][0]["repos_payload"],
        "expected_repos": TEST_PAYLOAD[0][0]["expected_repos"],
        "apache2_repos": TEST_PAYLOAD[0][0]["apache2_repos"],
    }
])
